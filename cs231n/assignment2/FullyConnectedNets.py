...
def test_FullyConnectedNet_gradient():
...
def test_FullyConnectedNet_overfit(num_layers, learning_rate):
    num_train = 50
    small_data = {
    ...
    weight_scale = 3e-2
    hidden_dims = np.full(num_layers - 1, 100, np.int32)
...
# overfit 3 and 5 layer nets
# test_FullyConnectedNet_overfit(3, 8e-4)
# test_FullyConnectedNet_overfit(5, 39e-3)
...
def test_RMSProp():
    ...
    print('next_x error: ', rel_error(expected_next_w, next_w))
